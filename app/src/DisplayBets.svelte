...
<div class="flex flex-col max-w-full items-center">
	...
	{:else if games.length > 0}
		...
		<table class="mt-10 rounded-xl bg-base-100">
			<tr>
				<th class="game-heading px-8 py-4">Game</th>
				<th class="px-8 py-4">{$loggedInUser?.username}</th>
				<th class="px-8 py-4">{selectedUser.username}</th>
			</tr>
			<tr>
				<td class="px-8 py-4 text-center">Points</td>
