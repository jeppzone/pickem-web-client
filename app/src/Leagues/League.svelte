...
<div class="container">
  ...
  {:else}
    {#if users && league}
      ...
      {/if}
      <Leaderboard leaderboard={regularSeasonLeaderboard} leaderboardHeader={"Regular season standings"} />
      <Leaderboard leaderboard={postSeasonLeaderboard} leaderboardHeader={"Post season standings"} />
    {/if}
